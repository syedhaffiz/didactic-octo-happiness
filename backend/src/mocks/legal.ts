// Deterministic mock data for the Legal module. Seeded so fixtures are stable
// across runs. Mirror of frontend/src/mocks/legal.ts.
...
// --- Summary ---------------------------------------------------------------
// Counts match the Figma. Derived counts (e.g. items.length) would diverge
// from the design as soon as we add/remove mock rows; keep summary independent.
...
// --- Critical Cases --------------------------------------------------------
// Hand-authored to mirror the Figma's first 5 rows (the visible ones) plus 11
// generated rows so the table reaches the Figma's "Total Cases = 16" total.
...
const FIGMA_CASES: Omit<CriticalCase, "srNo">[] = [
  {
    ...
    currentStatus:
      "The Hon'ble HC through its Order dated 28.03.2023 ordered WBPDCL to pay Rs. 32.34 Cr to AEL in relation to Arbitration Award. This was duly received by AEL. Later, as per the HC's Order dated 02.07.2024, we filed our opposition affidavit to the S.34 Petition filed by WBPDCL. They have not filed their reply to the same yet. On 07.05.2026, our counsel mentioned the matter. However, it was notified by the opposite party's present counsels i.e. Fox and Mandal, that they might not continue to represent the Claimant in the matter pertaining to the change in govt. Hence, the Ld. Judge asked our counsel to mention the matter after 2 weeks.",
  },
  {
    caseNo: "AA 99/2022",
    category: "SEB",
  ...
  },
  {
    ...
    claim: "Rs. 89.61 Cr. + Interest",
    costIncurred:
      "Stamp Duty payment of Rs 2.69 Cr. (approx)",
...
// Lightweight generators so totalCases (16) is meaningful without crafting 16
// full rows by hand. Generated rows are clearly placeholder ('Generated …') so
// real data swaps in cleanly.
...
const ISSUES: Omit<CriticalIssue, "srNo">[] = [
  {
    ...
    amountInvolved: "NA",
    currentStatus:
      "We are currently in the process of data/document collation.",
  },
];
