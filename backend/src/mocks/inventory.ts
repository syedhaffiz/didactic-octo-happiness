...
// Filter params now arrive as ids (e.g. "mundra"). The rest of this module
// works in display names because the seed/lookup tables (PORT_LEVELS,
// vessel origins, etc.) are name-keyed. Convert once at the boundary.
